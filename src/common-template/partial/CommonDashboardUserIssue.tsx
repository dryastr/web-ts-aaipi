...
import Modal, { ModalBody, ModalHeader, ModalTitle } from 'src/components/bootstrap/Modal';
import FormGroup from 'src/components/bootstrap/forms/FormGroup';
import Input from 'src/components/bootstrap/forms/Input';
import Todo, { ITodoListItem } from 'src/components/extras/Todo';
import Label from 'src/components/bootstrap/forms/Label';
import Checks, { ChecksGroup } from 'src/components/bootstrap/forms/Checks';
import Badge from 'src/components/bootstrap/Badge';
import Progress from 'src/components/bootstrap/Progress';
						...
						<ModalBody>
							<form className='row g-3' onSubmit={formik.handleSubmit}>
								...
								<div className='col-12'>
									...
									<div className='text-center mt-n4' id='picker'>
										<DatePicker
								...
								<div className='col-12'>
									<FormGroup>
										<Label htmlFor='checkgroup'>Badge</Label>
										<ChecksGroup isInline id='checkgroup'>
